...
public class Triangle{
    ...
    /**
     * Create a new triangle at default position with the specified color,width, and height.
     ...
     * @param times the number of steps to move; positive values move right, negative values move left
     */
     ...
     * @return the perimeter of the triangle0
     */
